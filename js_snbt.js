function playLatch() {
        ...
        function goComment(){
            var comment = confirm('Sudah menggunakan jasa pembuatan website kami? ⭐⭐⭐ Yuk, bagikan pengalaman dan testimoni kamu! Tekan OK untuk melihat portofolio dan memberikan ulasan.')
            if(comment){
                window.location.href = "https://mifta.vercel.app"
            }
        }
        function bantuAku() {
            var result = confirm("Butuh joki pembuatan website pengumuman SNBT 2025? Cek portofolio saya di https://mifta.vercel.app dan testimoni real di https://mifta.vercel.app/en/joki.html. Klik OK untuk chat via WhatsApp!");
            if (result) {
                window.location.href = "https://wa.me/62881026959655?text=Halo,%20saya%20tertarik%20dengan%20jasa%20pembuatan%20website%20pengumuman%20SNBT%202025%20kak!"
            }
        }
        function alertAuthor(){
            var author = confirm('Author website ini adalah seorang developer yang menyediakan jasa joki pembuatan website! Cek IG @miftaa_id, Klik OK untuk ke IG.')
            if(author){
            window.location.href = "https://instagram.com/miftaa_id"
            }
        }
        let abb=0
        function hideMenu(){
        ...
        function alertFeedback() {
            var result = confirm("Beri masukan anda mengenai website ini, saran dan kritik sangat dihargai! Klik OK untuk mengirim via WhatsApp.");
            if (result) {
                window.location.href = "https://wa.me/62881026959655?text=Halo,%20saya%20ingin%20memberikan%20feedback%20terkait%20pembuatan%20website%20pengumuman%20SNBT%202025%20kak!"
            }
        }
        function alertNote() {
            alert("Web ini dibuat untuk keperluan joki pembuatan website pengumuman SNBT 2025. Lihat portofolio saya di https://mifta.vercel.app dan testimoni real di https://mifta.vercel.app/en/joki.html. Harap gunakan dengan bijak!");
        }
    ...
    function getWidth() {
        ...
        var qrcode = new QRCode(blockQr, {
            text: `Made with SNBT GENERATOR : https://mifta.vercel.app/ ~${document.getElementById('inope').value}`,
            width: getWidth()-30,
            height: getWidth()-30,
